...
def create_app(config=None):
    ...
    def download_padding_pdf(user_id, left, top, right, bottom, filename):
        ...
        os.system('pdfjam --fitpaper true --trim "{}cm {}cm {}cm {}cm" "static/before_add_padding/{}" -o "static/after_add_padding/{}"'.format(-int(
            left), -int(bottom), -int(right), -int(top), filename, filename))
